...
data "aws_iam_policy_document" "controller" {
  ...
  dynamic "statement" {
    ...
    content {
      ...
      resources = [try(aws_sqs_queue.this.arn, null)]
      actions = [
        "sqs:DeleteMessage",
  ...
  statement {
    ...
    resources = local.create_node_iam_role ? [aws_iam_role.node.arn] : [var.node_iam_role_arn]
...
resource "aws_eks_access_entry" "node" {
  ...
  principal_arn = var.create_node_iam_role ? aws_iam_role.node.arn : var.node_iam_role_arn
...
resource "aws_iam_instance_profile" "this" {
  ...
  name_prefix = var.node_iam_role_use_name_prefix ? "${local.node_iam_role_name}-" : null
  path        = var.node_iam_role_path
  role        = var.create_node_iam_role ? aws_iam_role.node.name : local.external_role_name
